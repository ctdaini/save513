...
// var mycars=new Array()
    ...
    ylf,ylf_10,ylf_09,ylf_08,   ylf_07,   ylf_06,   ylf_05,   ylf_04,   ylf_03,   ylf_02,   ylf_01,   gwylf_die,
    zyts, zyts_10,zyts_09, zyts_08,  zyts_07,  zyts_06,  zyts_05,  zyts_04,  zyts_03,  zyts_02,  zyts_01,  zyts_die, 
    jtf,  jtf_10, jtf_09,  jtf_08,   jtf_07,   jtf_06,   jtf_05,   jtf_04,   jtf_03,   jtf_02,   jtf_01,   jtf_die,  
    tglxq,tglxq_10,tglxq_09,tglxq_08, tglxq_07, tglxq_06, tglxq_05, tglxq_04, tglxq_03, tglxq_02, tglxq_01, 
    ygz,  ygz_10, ygz_09,  ygz_08,   ygz_07,   ygz_06,   ygz_05,   ygz_04,   ygz_03,   ygz_02,   ygz_01,   ygz_die,  
    hlf00,hlf10,  hlf09,   hlf08,    hlf07,    hlf06,    hlf05,    hlf04,    hlf03,    hlf02,    hlf01,    hlf_die,  
    fzqjfy_06,fzqjfy_05,fzqjfy_04,fzqjfy_03,fzqjfy_02,fzqjfy_01,
    qtqso04,  qtqso03,  qtqso02,  qtqso01,  qtqsodie, 
    qtqs04,   qtqs03,   qtqs02,   qtqs01,   qtqsdie);
    var arr_all2=new Array(
    "ylf","ylf_10","ylf_09","ylf_08","ylf_07","ylf_06","ylf_05","ylf_04","ylf_03","ylf_02","ylf_01","gwylf_die",
    "zyts","zyts_10","zyts_09","zyts_08","zyts_07","zyts_06","zyts_05","zyts_04","zyts_03","zyts_02","zyts_01","zyts_die", 
    "jtf","jtf_10","jtf_09","jtf_08","jtf_07","jtf_06","jtf_05","jtf_04","jtf_03","jtf_02","jtf_01","jtf_die",  
    "tglxq","tglxq_10","tglxq_09", "tglxq_08","tglxq_07", "tglxq_06", "tglxq_05", "tglxq_04", "tglxq_03", "tglxq_02", "tglxq_01",
...
function show_alert(result, alertHtml) {
    ...
    alertHtml += ' <div class="weui_dialog_bd">' + title_res+'</div>';
...
function show_alert14(result, result2, result3, result4, alertHtml) {
    ...
    alertHtml += ' <div class="weui_dialog_hd"><strong class="weui_dialog_title">' + dialog_title + '</strong></div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_gspcj + result + title_yuan + '</div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_scjt + result2 + title_yuan +title_meiyue+ '</div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_shhlf + result3 + title_yuan + title_meiyue+'</div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_gyqsfxj + result4 + title_yuan + title_meiyue+'</div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_res+'</div>';
    alertHtml += ' <div class="weui_dialog_ft">';
    alertHtml += ' <a href="javascript:hide_alert();"class="weui_btn_dialog primary">确定</a>';
    alertHtml += ' </div>';
...
function show_alert_die(result, result2, alertHtml) {
    ...
    alertHtml += ' <div class="weui_dialog_hd"><strong class="weui_dialog_title">' + dialog_title + '</strong></div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_gspcj + result + title_yuan + '</div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_gyqsfxj + result2 + title_yuan + title_meiyue+'</div>';
    alertHtml += ' <div class="weui_dialog_bd">' + title_res+'</div>';
    alertHtml += ' <div class="weui_dialog_ft">';
    alertHtml += ' <a href="javascript:hide_alert();"class="weui_btn_dialog primary">确定</a>';
    alertHtml += ' </div>';
