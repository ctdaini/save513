...
weui_alert.find('.weui_btn_dialog').on('click', function() {
weui_alert.hide();
if (callback) {
callback();
}
...
weui_confirm.show();
weui_confirm.find(".weui_dialog_title").text(title ?"确认提示": title);
weui_confirm.find(".weui_dialog_bd").html(msg);
weui_confirm.find('.primary').on('click', function() {
weui_confirm.hide();
if (callback) {
callback(true);
}
});
weui_confirm.find('.default').on('click', function() {
weui_confirm.hide();
if (callback) {
callback(false);
}
